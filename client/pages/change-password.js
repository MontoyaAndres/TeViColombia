  ...
  <div className="hero-body">
    <div className="container animated bounceInLeft">
      <div className="notification is-warning">
        Si esta aquí, es porque usted desea cambiar la contraseña de su cuenta.
        Recuerde que no puede ingresar a Te vi Colombia hasta que el proceso de
        cambio de contraseña sea completado, si la llave de esta sección esta
        caducada, intente ingresando nuevamente su correo en{" "}
        <a
