    ...
    <div className="container animated bounceInLeft">
      <div className="notification is-warning">
        <p className="subtitle">
          ...
          para Te vi Colombia, por ello se tiene una sección especial para hacer
          cualquier cambio. Si el correo electrónico o contraseña es cambiado,
          todas las secciones en teléfonos y computadoras hechas en Te Vi
          Colombia van a ser eliminadas.
        </p>
      </div>
